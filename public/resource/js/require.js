...
(function(ca) {
    function G(b) { return "[object Function]" === M.call(b) }

    function H(b) { return "[object Array]" === M.call(b) }

    function v(b, c) { if (b) { var d; for (d = 0; d < b.length && (!b[d] || !c(b[d], d, b)); d += 1); } }

    function U(b, c) { if (b) { var d; for (d = b.length - 1; - 1 < d && (!b[d] || !c(b[d], d, b)); d -= 1); } }

    function s(b, c) { return ga.call(b, c) }
    ...
    function ha(b) {
        ...
        function g(a) { var e = j(l.paths, a); if (e && H(e) && 1 < e.length) return e.shift(), i.require.undef(a), i.require([a]), !0 }
        ...
        function m(a, e, b, f) {
            ...
            a = a[1];
            g && (g = c(g, h, f), d = j(p, g));
            a && (g ? k = d && d.normalize ? d.normalize(a, function(a) { return c(a, h, f) }) : c(a, h, f) : (k = c(a, h, f), a = u(k), g = a[0], k = a[1], b = !0, n = i.nameToUrl(k)));
        ...
        function w(a, e) {
            var b = a.requireModules,
                f = !1;
            if (e) e(a);
            else if (v(b, function(e) { if (e = j(k, e)) e.error = a, e.events.error && (f = !0, e.emit("error", a)) }), !f) h.onError(a)
        }
        ...
        N = {
            ...
            exports: function(a) { a.usingExports = !0; if (a.map.isDefine) return a.exports ? p[a.map.id] = a.exports : a.exports = p[a.map.id] = {} },
            module: function(a) {
                return a.module ?
        ...
        $.prototype = {
            ...
            callPlugin: function() {
                ...
                r(d, "defined", t(this, function(f) {
                    ...
                    } else g ? (this.map.url = i.nameToUrl(g), this.load()) : (d = t(this, function(a) { this.init([], function() { return a }, null, { enabled: !0 }) }), d.error = t(this, function(a) {
                        this.inited = !0;
                        this.error = a;
                        a.requireModules = [b];
            ...
            enable: function() {
                ...
                v(this.depMaps, t(this, function(a, b) {
                    ...
                    if ("string" === typeof a) {
                        ...
                        this.depMaps[b] = a;
                        if (c = j(N, a.id)) { this.depExports[b] = c(this); return }
                        this.depCount += 1;
        ...
        i = {
            ...
            makeRequire: function(a, e) {
                ...
                V(g, {
                    ...
                    specified: function(b) { b = m(b, a, !1, !0).id; return s(p, b) || s(k, b) }
                });
    ...
    if ("undefined" === typeof define) {
        ...
        h({});
        v(["toUrl", "undef", "defined", "specified"], function(b) { h[b] = function() { var c = F._; return c.require[b].apply(c, arguments) } });
        ...
        define = function(b, c, d) {
            ...
            if (O) {
                if (!(g = L)) P && "interactive" === P.readyState || U(document.getElementsByTagName("script"), function(b) { if ("interactive" === b.readyState) return P = b }), g = P;
                g && (b ||
...
require.config({
    baseUrl: './resource',
    paths: {
        jquery: ['http://cdn.bootcss.com/jquery/1.12.3/jquery.min', 'js/jquery-1.12.3.min'],
        bootstrap: ['bootstrap/js/bootstrap.min'],
        sbadmin2: ['js/plugins/sb-admin-2/sb-admin-2'],
        metisMenu: ['js/plugins/metisMenu/metisMenu'],
        datatables: ['js/plugins/datatables/datatables'],
        'datatables.net': ['js/plugins/datatables/jquery.dataTables.min'],
        datatablesBootstrap: ['js/plugins/datatables/dataTables.bootstrap.min'],
        pagination: ['js/plugins/pagination/jquery.pagination'],
        frontPagination: ['js/plugins/pagination/jquery.front-pagination'],
        showloading: ['js/plugins/loading/showLoading'],
        ajaxfileupload: ['js/plugins/upload/ajaxfileupload'],
        ueditorConfig: ['js/plugins/ueditor1_4_3_1/ueditor.config'],
        ueditor: ['js/plugins/ueditor1_4_3_1/ueditor.all'],
        ZeroClipboard: ['js/plugins/ueditor1_4_3_1/third-party/zeroclipboard/ZeroClipboard'],
        treeview: ['js/plugins/treeview/bootstrap-treeview'],
        validForm: ['js/plugins/validform/Validform_v5.3.2_min'],
        fullPage: ['js/plugins/jquery/jquery.fullPage.min'],
        easing: ['js/plugins/jquery/jquery.easing.min'],
        superSlide: ['js/plugins/jquery/superslide.min'],
        frontCommon: ['js/front-common'],
        common: ['js/common'],
        touchSlide: ['js/plugins/jquery/TouchSlide.1.1'],
