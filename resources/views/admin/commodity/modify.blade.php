                ...
                <div class="col-sm-6 hidden-xs">
                    <div class="header-section">
                        <ul class="breadcrumb breadcrumb-top">
                            ...
                            <li><a href="{{route('staff.commodity.modify', ['id'=> $data->id])}}">修改商品</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="block">
                    ...
                    <form id="form-validation" action="{{route('staff.commodity.modify', ['id'=>$data->id])}}" method="post" class="form-horizontal form-bordered">
